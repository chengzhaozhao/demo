...
import com.czz.springboot.demo.config.security.ServerConfig;
import com.czz.springboot.demo.domain.Token;
import com.czz.springboot.demo.dto.LoginUserDTO;
import com.czz.springboot.demo.dto.UserDTO;
import com.czz.springboot.demo.enums.ResponseEnum;
import com.czz.springboot.demo.enums.UrlEnum;
import com.czz.springboot.demo.repository.UserRepository;
import com.czz.springboot.demo.service.RoleService;
import com.czz.springboot.demo.service.UserService;
import com.czz.springboot.demo.util.BeanUtils;
import com.czz.springboot.demo.util.RedisUtil;
import com.czz.springboot.demo.vo.LoginUserVO;
...
import static com.czz.springboot.demo.config.security.OAuth2Config.*;
...
public class UserServiceImpl implements UserService {
    ...
    public ResponseVO login(LoginUserDTO loginUserDTO) {
        ...
        try {
            ...
            //所以这里我用restTemplate(HTTP客户端)进行一次转发到oauth2内部的登录接口，比较简单粗暴  客户端进行内部转发
            ...
            if(loginUserVO != null){
                ...
                //                //不便于做单点维护
                token = oauthRefreshToken(loginUserVO.getRefreshToken()); // 刷新token 删除原来缓存中的token
        ...
        //存储登录的用户
        redisUtil.set(loginUserVO.getAccessToken(),loginUserVO,TimeUnit.HOURS.toSeconds(1)); // 获取token 在重新进行封装
